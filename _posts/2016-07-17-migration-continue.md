...
Je préconise cepandant le fait de supprimer toute allusion au code de l'ancienne version sur la branche de la nouvelle version. Cette opération _évite_ que les devs copy/paste/move le code sans le lire (et donc sans augmenter ses chances de le réfactoriser). Le mot d'ordre était alors "s'en inspirer, le refactorer, et à défaut, le reprendre tel quel".
